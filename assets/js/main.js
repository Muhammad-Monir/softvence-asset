    ...
    e(document).ready(function () {
        e(window).on("load", function () {
            if (
                ...
                gsap.timeline().from(".char", { duration: 1, opacity: 0, skew: 7, stagger: 0.02, y: 200, ease: "power1.inOut" }),
                gsap.from(".hero--area .hero--box.branding--area p", { duration: 1, opacity: 0, skew: 7, stagger: 0.02, y: 200, ease: "power1.inOut" }),
                gsap.from(".hero--play--area", { duration: 1.5, opacity: 0, y: 250, ease: "power1.inOut" }),
                gsap.fromTo(".circle--hero", { opacity: 0 }, { duration: 1, opacity: 1, delay: 1, ease: "power1.inOut" }),
        ...
        if (
            ((window.onscroll = function () {
                var e;
                (e = window.pageYOffset || document.documentElement.scrollTop) > t ? o.classList.add("hide") : o.classList.remove("hide"), (t = e <= 0 ? 0 : e);
            }),
            AOS.init({ duration: 700, easing: "cubic-bezier(0.165, 0.84, 0.44, 1)", once: !0, startEvent: "load" }),
            ...
            gsap.registerPlugin(ScrollTrigger);
            var r,
                a = document.querySelector(".scale--circle");
            gsap.timeline({ scrollTrigger: { trigger: ".case--studies--area", start: "-8% center", end: "center center", scrub: 0.5 } }).to(a, { width: "5000px", height: "5000px", ease: "power1.out" });
        }
        let s, n, i, c, l, p;
        if (
            ((s = e(".body--cursor")),
        ...
        e(".hero--play--area").bind("click", function (o) {
            ...
            e(".work--step--area").length > 0 &&
                ((w = {
                    step1: lottie.loadAnimation({ container: document.querySelector(".target1"), renderer: "svg", loop: !0, autoplay: !1, path: "https://softvence.agency/wp-content/uploads/2024/03/discovery.json" }),
                    step2: lottie.loadAnimation({
                        container: document.querySelector(".target2"),
                        renderer: "svg",
                        loop: !0,
                        autoplay: !1,
                        path: "https://softvence.agency/wp-content/uploads/2024/03/design.json",
                        rendererSettings: { preserveAspectRatio: "xMidYMid meet", forceRender: !1 },
                    }),
                    step3: lottie.loadAnimation({ container: document.querySelector(".target3"), renderer: "svg", loop: !0, autoplay: !1, path: "https://softvence.agency/wp-content/uploads/2024/03/development.json" }),
                    step4: lottie.loadAnimation({ container: document.querySelector(".target4"), renderer: "svg", loop: !0, autoplay: !1, path: "https://softvence.agency/wp-content/uploads/2024/03/testing.json" }),
                    step5: lottie.loadAnimation({ container: document.querySelector(".target5"), renderer: "svg", loop: !0, autoplay: !1, path: "https://softvence.agency/wp-content/uploads/2024/03/improve.json" }),
                    step6: lottie.loadAnimation({ container: document.querySelector(".target6"), renderer: "svg", loop: !0, autoplay: !1, path: "https://softvence.agency/wp-content/uploads/2024/03/complete.json" }),
                }),
                (k = {
