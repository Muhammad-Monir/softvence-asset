    ...
    e(document).ready(function () {
        ...
        e(".hero--play--area").bind("click", function (o) {
            ...
            e(".work--step--area").length > 0 &&
                ((w = {
                    step1: lottie.loadAnimation({ container: document.querySelector(".target1"), renderer: "svg", loop: !0, autoplay: !1, path: "assets/json/discovery.json" }),
                    step2: lottie.loadAnimation({
                        container: document.querySelector(".target2"),
                        renderer: "svg",
                        loop: !0,
                        autoplay: !1,
                        path: "assets/json/design.json",
                        rendererSettings: { preserveAspectRatio: "xMidYMid meet", forceRender: !1 },
                    }),
                    step3: lottie.loadAnimation({ container: document.querySelector(".target3"), renderer: "svg", loop: !0, autoplay: !1, path: "assets/json/development.json" }),
                    step4: lottie.loadAnimation({ container: document.querySelector(".target4"), renderer: "svg", loop: !0, autoplay: !1, path: "assets/json/testing.json" }),
                    step5: lottie.loadAnimation({ container: document.querySelector(".target5"), renderer: "svg", loop: !0, autoplay: !1, path: "assets/json/improve.json" }),
                    step6: lottie.loadAnimation({ container: document.querySelector(".target6"), renderer: "svg", loop: !0, autoplay: !1, path: "assets/json/complete.json" }),
                }),
                (k = {
